...
async def get_projects_by_owner(db: AsyncIOMotorDatabase, owner_id: str) -> List[Project]:
...
async def get_projects_by_member(db: AsyncIOMotorDatabase, member_id: str) -> List[Project]:
...
async def create_project(db: AsyncIOMotorDatabase, project_data: ProjectCreate) -> Project:
    project_doc = {
...
async def update_project(db: AsyncIOMotorDatabase, project_id: str, project_data: ProjectUpdate) -> Optional[Project]:
    if not ObjectId.is_valid(project_id):
        return None
