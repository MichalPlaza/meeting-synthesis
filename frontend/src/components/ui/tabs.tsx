...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center bg-transparent p-1 text-muted-foreground border-b",
      className
    )}
    {...props}
  />
